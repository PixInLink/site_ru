...
export default defineNuxtConfig({
  app: {
    ...
    head: {
      title: brand.cloud.name,
      meta: [
        { charset: 'utf-8' },
        { name: 'viewport', content: 'width=device-width, initial-scale=1' },
        { name: 'description', content: brand.cloud.desc },
        ...
        { property: 'og:url', content: brand.cloud.url },
        { property: 'og:title', content: brand.cloud.projectName },
        { property: 'og:description', content: brand.cloud.desc },
        { name: 'twitter:site', content: brand.cloud.url },
        { name: 'twitter:card', content: 'summary_large_image' },
        { name: 'twitter:image', content: brand.cloud.img },
        { property: 'og:image', content: brand.cloud.img },
