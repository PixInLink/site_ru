...
export default defineNuxtConfig({
  app: {
    ...
    head: {
      title: brand.fintech.name,
      meta: [
        { charset: 'utf-8' },
        { name: 'viewport', content: 'width=device-width, initial-scale=1' },
        { name: 'description', content: brand.fintech.desc },
        ...
        { property: 'og:url', content: brand.fintech.url },
        { property: 'og:title', content: brand.fintech.projectName },
        { property: 'og:description', content: brand.fintech.desc },
        { name: 'twitter:site', content: brand.fintech.url },
        { name: 'twitter:card', content: 'summary_large_image' },
        { name: 'twitter:image', content: brand.fintech.img },
        { property: 'og:image', content: brand.fintech.img },
