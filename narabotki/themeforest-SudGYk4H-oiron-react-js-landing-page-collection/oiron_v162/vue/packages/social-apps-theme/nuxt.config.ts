...
export default defineNuxtConfig({
  app: {
    ...
    head: {
      title: brand.social.name,
      meta: [
        { charset: 'utf-8' },
        { name: 'viewport', content: 'width=device-width, initial-scale=1' },
        { name: 'description', content: brand.social.desc },
        ...
        { property: 'og:url', content: brand.social.url },
        { property: 'og:title', content: brand.social.projectName },
        { property: 'og:description', content: brand.social.desc },
        { name: 'twitter:site', content: brand.social.url },
        { name: 'twitter:card', content: 'summary_large_image' },
        { name: 'twitter:image', content: brand.social.img },
        { property: 'og:image', content: brand.social.img },
