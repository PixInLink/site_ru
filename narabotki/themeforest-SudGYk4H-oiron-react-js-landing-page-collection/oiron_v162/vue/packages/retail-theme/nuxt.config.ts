...
export default defineNuxtConfig({
  app: {
    ...
    head: {
      title: brand.retail.name,
      meta: [
        { charset: 'utf-8' },
        { name: 'viewport', content: 'width=device-width, initial-scale=1' },
        { name: 'description', content: brand.retail.desc },
        ...
        { property: 'og:url', content: brand.retail.url },
        { property: 'og:title', content: brand.retail.projectName },
        { property: 'og:description', content: brand.retail.desc },
        { name: 'twitter:site', content: brand.retail.url },
        { name: 'twitter:card', content: 'summary_large_image' },
        { name: 'twitter:image', content: brand.retail.img },
        { property: 'og:image', content: brand.retail.img },
