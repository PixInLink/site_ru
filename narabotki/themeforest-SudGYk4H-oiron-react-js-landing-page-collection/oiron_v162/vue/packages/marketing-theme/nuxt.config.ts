...
export default defineNuxtConfig({
  app: {
    ...
    head: {
      title: brand.marketing.name,
      meta: [
        { charset: 'utf-8' },
        { name: 'viewport', content: 'width=device-width, initial-scale=1' },
        { name: 'description', content: brand.marketing.desc },
        ...
        { property: 'og:url', content: brand.marketing.url },
        { property: 'og:title', content: brand.marketing.projectName },
        { property: 'og:description', content: brand.marketing.desc },
        { name: 'twitter:site', content: brand.marketing.url },
        { name: 'twitter:card', content: 'summary_large_image' },
        { name: 'twitter:image', content: brand.marketing.img },
        { property: 'og:image', content: brand.marketing.img },
