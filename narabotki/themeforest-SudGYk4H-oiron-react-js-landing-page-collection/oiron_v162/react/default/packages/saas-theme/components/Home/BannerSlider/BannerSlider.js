    ...
    <div className={classes.bannerWrap}>
      <div className={classes.carousel}>
        ...
        >
                    ...
                    <Box px={3} alignItems="center">
                      <div className={classes.text}>
                        ...
                        <div className={classes.btnArea}>
                          <Button size="large" color="primary" href="#" className={cx(classes.button, classes.textBtn)}>
                            {t('btn_detail')}
                          </Button>
                          <Button size="large" variant="contained" color="secondary" href={link.saas.register} className={cx(classes.button, classes.containedBtn)}>
                  ...
                  <Grid item md={6} xs={12}>
                    <Box px={{ sm: 3 }}>
                      <div className={classes.img}>
                        <div className={cx(classes.ovalFloor, classes.slide1)} />
                        <img
          ...
          <div className={classes.slide}>
            <div className={classes.inner}>
              <div className={cx(classes.img, classes.backgroundBanner, classes.mobile)}>
                <img
                  src={imgAPI.saas[5]}
                  data-2d={imgAPI.saas[4]}
                  data-3d={imgAPI.saas[5]}
              ...
              <Container>
                <Grid container spacing={2} alignItems="center" justifyContent="flex-end" direction={isMobile ? 'column-reverse' : 'row'}>
                  <Grid item md={6} xs={12}>
                    <Box px={{ sm: 3 }}>
                      <div className={classes.img}>
                        <div className={cx(classes.ovalFloor, classes.slide2)} />
                        <img
                ...
                <Grid container spacing={2} justifyContent="flex-end">
                  ...
                  <Grid item md={12} xs={12}>
                    <div className={cx(classes.img, classes.hBanner)}>
                      <div className={cx(classes.ovalFloor, classes.slide3)} />
                      <img
                        className="img-2d3d"
                        src={imgAPI.saas[7]}
