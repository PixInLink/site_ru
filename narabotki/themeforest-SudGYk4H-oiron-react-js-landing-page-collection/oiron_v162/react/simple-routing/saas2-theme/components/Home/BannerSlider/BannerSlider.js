                    ...
                    <Box px={{ xs: 0, sm: 3 }} alignItems="center">
                      <div className={classes.text}>
                        ...
                        <div className={classes.btnArea}>
                          <Button size="large" href="#" className={cx(classes.button, classes.textBtn)}>
                            {t('btn_detail')}
                          </Button>
                          <Button size="large" variant="contained" color="secondary" href={link.saas2.register} className={cx(classes.button, classes.containedBtn)}>
