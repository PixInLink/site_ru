...
const useStyles = makeStyles({ uniqId: 'action' })(theme => ({
  ...
  paper: {
    ...
    boxShadow: theme.palette.mode === 'dark' ? '0px 1px 3px 0px rgba(64, 64, 64, 1), 0px 1px 1px 0px rgba(42, 42, 42, 1), 0px 2px 1px -1px rgba(20, 20, 20, 1)' : '0 1.5px 12px 2px rgba(0, 0, 0, 0.06)',
    [theme.breakpoints.down('md')]: {
      textAlign: 'center'
    },
