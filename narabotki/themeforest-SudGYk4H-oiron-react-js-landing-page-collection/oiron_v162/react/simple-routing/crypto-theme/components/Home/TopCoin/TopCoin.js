  ...
  return (
    <div className={classes.root}>
      ...
      <div className={classes.slideWrap}>
        ...
        <Fab size="small" onClick={() => slider.current.slickNext()} aria-label="prev" className={cx(classes.nav, classes.prev)}>
          <i className="ion-chevron-left" />
        </Fab>
        <Fab size="small" onClick={() => slider.current.slickPrev()} aria-label="next" className={cx(classes.nav, classes.next)}>
