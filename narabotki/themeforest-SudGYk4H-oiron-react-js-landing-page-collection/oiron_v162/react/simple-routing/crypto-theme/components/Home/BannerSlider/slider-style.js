...
const sliderStyle = makeStyles({ uniqId: 'banner_slider' })((theme, _params, classes) => ({
  ...
  root: {
    position: 'relative',
    overflow: 'hidden',
    backgroundImage: theme.palette.mode === 'dark' ? `linear-gradient(120deg, ${darken(theme.palette.primary.main, 0.6)}, ${darken(theme.palette.secondary.main, 0.6)})` : `linear-gradient(120deg, ${lighten(theme.palette.primary.main, 0.9)}, ${lighten(theme.palette.secondary.main, 0.9)})`,
    paddingBottom: 320,
    marginBottom: -320,
    ...
    '&:after': {
      ...
      width: '100%',
      height: '100%',
      backgroundImage: `url(${theme.palette.mode === 'dark' ? decoBottomDark : decoBottomLight})`,
