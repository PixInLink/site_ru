...
<section class="space-top space-top-short-md" id="services">
  <div class="root">
    <div class="container carousel-header">
      <h4 class="title-primary">7 функций, которые экономят время</h4>
    </div>
    <div class="carousel-handle">
      <div class="carousel-wrap">
        <div class="carousel">
          <div id="services_carousel" data-length="6">
            <div class="item">
              <div class="card product-card portrait over">
                <a class="waves-effect hidden-link" href="#">&nbsp;</a>
                <div class="figure">
                  <img src="https://pixinlink.ru/490x327/Иллюстрация-ссылка-как-контракт" loading="lazy" alt="URL-first API" />
                </div>
                <div class="desc">
                  <div class="text">
                    <h6 class="title pb-2 text-truncate">URL-first API</h6>
                    <p class="use-text-paragraph">Ссылка — это контракт. Один и тот же URL всегда вернёт одно и то же изображение. Вставляйте в &lt;img&gt;, og:image, CSS или Markdown.</p>
                  </div>
                  <div>
                    <a class="btn btn-outlined primary button block" href="#">пример URL</a>
                  </div>
                </div>
              </div>
            </div>
            <div class="item">
              <div class="card product-card portrait over">
                <a class="waves-effect hidden-link" href="#">&nbsp;</a>
                <div class="figure">
                  <img src="https://pixinlink.ru/490x327/Иллюстрация-гигачат-модель" loading="lazy" alt="GigaChat генерация" />
                </div>
                <div class="desc">
                  <div class="text">
                    <h6 class="title pb-2 text-truncate">GigaChat от Sber</h6>
                    <p class="use-text-paragraph">Основная модель нативно понимает русский контекст. При недоступности — мгновенный фоллбэк на FLUX.1-schnell без вашего участия.</p>
                  </div>
                  <div>
                    <a class="btn btn-outlined primary button block" href="#">сравнение моделей</a>
                  </div>
                </div>
              </div>
            </div>
            <div class="item">
              <div class="card product-card portrait over">
                <a class="waves-effect hidden-link" href="#">&nbsp;</a>
                <div class="figure">
                  <img src="https://pixinlink.ru/490x327/Иллюстрация-шесть-стилей" loading="lazy" alt="6 стилей генерации" />
                </div>
                <div class="desc">
                  <div class="text">
                    <h6 class="title pb-2 text-truncate">6 стилей в один клик</h6>
                    <p class="use-text-paragraph">Фотореализм, иллюстрация, 3D-рендер, пиксель-арт, киберпанк, аниме. Переключайте параметром &style= без перегенерации промпта.</p>
                  </div>
                  <div>
                    <a class="btn btn-outlined primary button block" href="#">посмотреть стили</a>
                  </div>
                </div>
              </div>
            </div>
            <div class="item">
              <div class="card product-card portrait over">
                <a class="waves-effect hidden-link" href="#">&nbsp;</a>
                <div class="figure">
                  <img src="https://pixinlink.ru/490x327/Иллюстрация-умный-перевод" loading="lazy" alt="Улучшение промпта" />
                </div>
                <div class="desc">
                  <div class="text">
                    <h6 class="title pb-2 text-truncate">Умный перевод промптов</h6>
                    <p class="use-text-paragraph">Пишите по-русски. Yandex Translate автоматически переведёт запрос, добавит style boosters и негативные промпты («blurry, low quality»).</p>
                  </div>
                  <div>
                    <a class="btn btn-outlined primary button block" href="#">как писать промпты</a>
                  </div>
                </div>
              </div>
            </div>
            <div class="item">
              <div class="card product-card portrait over">
                <a class="waves-effect hidden-link" href="#">&nbsp;</a>
                <div class="figure">
                  <img src="https://pixinlink.ru/490x327/Иллюстрация-быстрый-cdn" loading="lazy" alt="CDN-доставка" />
                </div>
                <div class="desc">
                  <div class="text">
                    <h6 class="title pb-2 text-truncate">CDN с 140 точками в РФ</h6>
                    <p class="use-text-paragraph">Кешированные изображения раздаются через Yandex Cloud CDN. TTFB менее 100 мс. Кеш на 1 год — повторные запросы мгновенны.</p>
                  </div>
                  <div>
                    <a class="btn btn-outlined primary button block" href="#">карта точек CDN</a>
                  </div>
                </div>
              </div>
            </div>
            <div class="item">
              <div class="card product-card portrait over">
                <a class="waves-effect hidden-link" href="#">&nbsp;</a>
                <div class="figure">
                  <img src="https://pixinlink.ru/490x327/Иллюстрация-оптимизация-webp" loading="lazy" alt="WebP-оптимизация" />
                </div>
                <div class="desc">
                  <div class="text">
                    <h6 class="title pb-2 text-truncate">WebP в 6 раз легче PNG</h6>
                    <p class="use-text-paragraph">По умолчанию отдаём WebP (~50 КБ вместо ~300 КБ для PNG). Картинки грузятся быстрее, PageSpeed растёт. Доступен AVIF для современных браузеров.</p>
                  </div>
                  <div>
                    <a class="btn btn-outlined primary button block" href="#">сравнение форматов</a>
                  </div>
                </div>
              </div>
            </div>
  ...
  <div class="root">
    <div class="container">
      <div class="row spacing8">
        <div class="col-lg-1 col-md-12 show-lg-up"></div>
        <div class="col-md-4 col-sm-12 px-6">
          <div class="title-deco mb-4 mb-md-0">
            <svg class="decoration show-md-up" fill="#cccccc" width="845px" height="1099px">
        ...
        <div class="col-lg-7 col-md-8 col-sm-12 px-6">
          <h4 class="title-default use-text-subtitle">Три сценария — одна ссылка.</h4>
          <p class="desc use-text-paragraph">Блогеры вставляют URL в WordPress. Разработчики вызывают API из Python-скрипта. Агентства генерируют 500 изображений за ночь через bulk-запрос. Все получают результат без ручной работы.</p>
          <div class="list">
            <div class="row">
              <div class="col-sm-6 px-0 py-2">
                <div class="desc-icon icon-primary"><i class="material-icons icon">check</i></div>
                <h3 class="use-text-subtitle">Блогеры и CMS</h3>
                <p class="use-text-paragraph">WordPress, ModX, Tilda. Плагин видит плейсхолдер и заменяет его на постоянную ссылку. Статья готова за 2 клика.</p>
              </div>
              <div class="col-sm-6 px-0 py-2">
                <div class="desc-icon icon-secondary"><i class="material-icons icon">code</i></div>
                <h3 class="use-text-subtitle">Разработчики</h3>
                <p class="use-text-paragraph">Python SDK, cURL, REST API. Генерация в фоне, webhook-уведомления, seed для стабильных обложек og:image.</p>
              </div>
              <div class="col-sm-6 px-0 py-2">
                <div class="desc-icon icon-accent"><i class="material-icons icon">business</i></div>
                <h3 class="use-text-subtitle">Агентства и бизнес</h3>
                <p class="use-text-paragraph">Bulk-генерация по CSV, кастомные водяные знаки, SLA 99.9%. Масштабируйте визуал без найма дизайнеров.</p>
              </div>
              <div class="col-sm-6 px-0 py-2">
...
<section class="space-top-short" id="testimonials">
  <div class="root">
    <div class="container carousel-header">
      <h4 class="title-primary">Что говорят пользователи</h4>
    </div>
    <div class="carousel">
      <div class="slick-carousel" id="testimonial_carousel" data-length="6">
        <div class="item">
          <div class="testi-card">
            <div class="card paper">
              <p>Раньше тратил 2 часа на подбор картинок для одной статьи. Теперь — 2 минуты. Просто вставляю ссылку в промпт ИИ, и всё готово.</p>
        ...
        <div class="item">
          <div class="testi-card">
            <div class="card paper">
              <p>Интегрировал PixInLink в наш WordPress-плагин за 15 минут. Клиенты генерируют обложки прямо в редакторе — без выхода в сторонние сервисы.</p>
              <div class="rating"><i class="material-icons star-icon" title="1">star</i><i class="material-icons star-icon" title="2">star</i><i class="material-icons star-icon" title="3">star</i><i class="material-icons star-icon" title="4">star</i><i class="material-icons star-icon" title="5">star</i></div>
            </div>
            <div class="person">
              <div class="avatar-img avatar">
        ...
        <div class="item">
          <div class="testi-card">
            <div class="card paper">
              <p>Запустили генерацию 300 изображений для каталога товаров через bulk-API. Все ссылки сохранились, водяные знаки — только на бесплатном тарифе. Идеально.</p>
              <div class="rating"><i class="material-icons star-icon" title="1">star</i><i class="material-icons star-icon" title="2">star</i><i class="material-icons star-icon" title="3">star</i><i class="material-icons star-icon" title="4">star</i><i class="material-icons star-icon" title="5">star</i></div>
            </div>
            <div class="person">
              <div class="avatar-img avatar">
        ...
        <div class="item">
          <div class="testi-card">
            <div class="card paper">
              <p>Seed-параметр спасает ог:image: обложка не меняется при каждом вызове. Это критично для соцсетей — ссылка должна вести на одну и ту же картинку.</p>
              <div class="rating"><i class="material-icons star-icon" title="1">star</i><i class="material-icons star-icon" title="2">star</i><i class="material-icons star-icon" title="3">star</i><i class="material-icons star-icon" title="4">star</i><i class="material-icons star-icon" title="5">star</i></div>
            </div>
            <div class="person">
              <div class="avatar-img avatar">
        ...
        <div class="item">
          <div class="testi-card">
            <div class="card paper">
              <p>WebP-оптимизация подняла наш PageSpeed с 68 до 92 баллов. Картинки грузятся мгновенно, трафик — в 6 раз меньше. Хостинг спасибо не сказал, но мы — да.</p>
              <div class="rating"><i class="material-icons star-icon" title="1">star</i><i class="material-icons star-icon" title="2">star</i><i class="material-icons star-icon" title="3">star</i><i class="material-icons star-icon" title="4">star</i><i class="material-icons star-icon" title="5">star</i></div>
            </div>
            <div class="person">
              <div class="avatar-img avatar">
        ...
        <div class="item">
          <div class="testi-card">
            <div class="card paper">
              <p>Бесплатный тариф — 12 изображений в месяц, без водяного знака. Это не триал, это навсегда. Апгрейд — когда понадобится масштаб. Честно.</p>
              <div class="rating"><i class="material-icons star-icon" title="1">star</i><i class="material-icons star-icon" title="2">star</i><i class="material-icons star-icon" title="3">star</i><i class="material-icons star-icon" title="4">star</i><i class="material-icons star-icon" title="5">star</i></div>
            </div>
            <div class="person">
              <div class="avatar-img avatar">
          ...
          <div class="root">
            <div class="card paper">
              <div class="row align-items-center mb-0">
                <div class="col-md-8 col-sm-12 pa-0">
                  <h4 class="use-text-title2 pb-2">12 изображений бесплатно</h4>
                  <p class="use-text-subtitle2">Без водяного знака. Без привязки карты. Апгрейд в любой момент.</p>
                </div>
