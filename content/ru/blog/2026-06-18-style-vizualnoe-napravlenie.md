...
Скопируйте URL, замените промпт и `?style=` — откройте в браузере. 30 генераций бесплатно, без регистрации.

```
https://pixinlink.ru/800x400/ваш-промпт?style=watercolor_anime
```

[30 генераций бесплатно](https://app.pixinlink.ru/register)
